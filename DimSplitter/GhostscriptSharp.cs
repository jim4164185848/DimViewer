...
namespace GhostscriptSharp
{
    ...
    public static class ResourceExtractor
    {
        ...
        public static Assembly ExtractResourceToAssembly(string resourceName)
        {
            using (System.IO.Stream s = System.Reflection.Assembly.GetExecutingAssembly().GetManifestResourceStream(resourceName))
            {
                byte[] b = new byte[s.Length];
    ...
    public class GhostscriptWrapper
    {
        ...
        /// at the output path
        /// </summary>
        public static void GeneratePageThumb(string inputPath, string outputPath, int page, int width, int height,int pdfbox)
        {
            GeneratePageThumbs(inputPath, outputPath, page, page, width, height,pdfbox);
        }
        ...
        /// </summary>
        public static void GeneratePageThumbs(string inputPath, string outputPath, int firstPage, int lastPage, int width, int height,int pdfbox)
        {
            CallAPI(GetArgs(inputPath, outputPath, firstPage, lastPage, width, height,pdfbox));
        }
        ...
        public static void GenerateOutput(string inputPath, string outputPath, GhostscriptSettings settings,int pdfbox)
        {
            CallAPI(GetArgs(inputPath, outputPath, settings,pdfbox));
        }
            ...
            int pdfbox)
        {
            ...
            return GetArgs(inputPath, outputPath, s,pdfbox);
        }
        ...
        private static string[] GetArgs(string inputPath,
            string outputPath,
            GhostscriptSettings settings,int pdfbox)
        {
